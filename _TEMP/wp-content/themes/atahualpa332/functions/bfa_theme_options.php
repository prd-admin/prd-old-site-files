...
$options1 = array(
    ...
    array(    "name" => "Thank you for using Atahualpa",
			...
			Discuss the Atahualpa theme, get language files and more at the <a href=\"http://forum.bytesforall.com/\">Bytes For All Forum</a>.<br />
			...
			the static CSS (which does not change) and header.php contains the dynamic CSS. The rules in header.php will overwrite any identical
			rule that may appear in style.css. Keep this CSS structure in mind when you want to manually edit the CSS styles of the theme.</li>
...
// New category: cat-menu-bar
    ...
    array(    "name" => "Add category description to menu bar tabs",
			...
			Site Admin -> Posts -> Categories -> Description) to the link text each category's button in the category menu bar. 
