...
.post img { <?php echo $bfa_ata['post_image_style']; ?> }

.wp-caption { <?php echo $bfa_ata['post_image_caption_style']; ?> }
...
<?php if (strpos($bfa_ata['configure_header'],'%pages')!==false OR strpos($bfa_ata['configure_header'],'%cats')!==false) { ?>
...
div#menu1 ul.rMenu li.rMenu-expand li.rMenu-expand li.rMenu-expand li.rMenu-expand li.rMenu-expand a 
	{
	background-image: url(<?php echo get_bloginfo('template_directory'); ?>/images/expand-right<?php echo ($bfa_ata['page_menu_arrows'] == "white" ? "-white" : ""); ?>.gif);
	}
...
div#menu2 ul.rMenu li.rMenu-expand li.rMenu-expand li.rMenu-expand li.rMenu-expand li.rMenu-expand a 
	{
	background-image: url(<?php echo get_bloginfo('template_directory'); ?>/images/expand-right<?php echo ($bfa_ata['cat_menu_arrows'] == "white" ? "-white" : ""); ?>.gif);
	}
	
div#menu1 ul.rMenu-hor li.rMenu-expand a
	{
	background-image: url(<?php echo get_bloginfo('template_directory'); ?>/images/expand-down<?php echo ($bfa_ata['page_menu_arrows'] == "white" ? "-white" : ""); ?>.gif);
	}
...
<style type="text/css">
.wp-pagenavi a:link, .wp-pagenavi a:visited, .wp-pagenavi a:active { color: #<?php echo $bfa_ata['link_color']; ?>; border: solid 1px #<?php echo $bfa_ata['link_color']; ?>; }
.wp-pagenavi a:hover { color: #<?php echo $bfa_ata['link_hover_color']; ?>; border: solid 1px #<?php echo $bfa_ata['link_hover_color']; ?>; }
</style>
<?php } ?>
...
if ( !is_single() AND !is_page() AND $bfa_ata['home_multi_next_prev'] != '' ) {
	$nav_home_div_on = '<div class="home"><a href="' . get_option('home') . '/">' . $bfa_ata['home_multi_next_prev'] . '</a></div>'; 
...
if ( is_single() ) {
	...
	$nav_home_div_on_single = '<div class="home"><a href="' . get_option('home') . '/">' . 
...
// figure out sidebars
global $cols, $left_col, $right_col;
?>
...
<?php } ?>
	...
	<tr id="bodyrow">
		...
		<td id="left">
			...
			if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar(1) ) : echo "To put some content here, 
			go to Site Admin -> Appearance/Presentation -> Widgets -> Select \"Left Sidebar\" -> Click \"Show\" -> 
