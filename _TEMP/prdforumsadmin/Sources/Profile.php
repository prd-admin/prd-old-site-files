...
function ModifyProfile($post_errors = array())
{
	...
	*/
	...
	$context['member'] = array(
		...
		'msn' => array('name' => empty($user_profile[$memID]['MSN']) ? '' : $user_profile[$memID]['MSN']),'gmail' => array('name' => empty($user_profile[$memID]['gmail']) ? '' : $user_profile[$memID]['gmail']),
		'website' => array(
...
function saveProfileChanges(&$profile_vars, &$post_errors, $memID)
{
	...
	$profile_strings = array(
		...
		'pm_ignore_list',
		'smileySet',
		'signature', 'personalText', 'avatar','gmail',
	);
...
function rememberPostData()
{
	...
	$context['member'] = array(
		...
		'gmail' => array(
			'name' => empty($_POST['gmail']) ? '' : stripslashes($_POST['gmail'])
