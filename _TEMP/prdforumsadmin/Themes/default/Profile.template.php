...
<table border="0" cellpadding="4" cellspacing="1" align="center" class="bordercolor">
	...
	echo '
				<tr>
					...
					<td><b>', $txt[604], ': </b></td>
					<td>', $context['member']['yim']['link_text'], '</td></tr><tr>
					<td><b>', $txt['gmail'], ': </b></td>
					<td>', $context['member']['gmail']['link_text'], '</td>
				</tr><tr>
					<td><b>', $txt[69], ': </b></td>
					<td>';
	...
	echo '
		<table border="0" width="85%" cellspacing="1" cellpadding="4" class="bordercolor" align="center">
			...
			<tr class="catbg3">
				...
				<td align="center">', $txt['MSN'], '</td><td align="center">', $txt['gmail'], '</td>
				<td></td>
			</tr>';
	...
	foreach ($context['buddies'] as $buddy)
	{
		echo '
			<tr class="', $alternate ? 'windowbg' : 'windowbg2', '">
				...
				<td align="center">', $buddy['msn']['link'], '</td><td align="center">', $buddy['gmail']['link'], '</td>
...
function template_forumProfile()
{
	...
	echo '
							<tr>
								...
								<td><input type="text" name="YIM" maxlength="32" size="24" value="', $context['member']['yim']['name'], '" /></td></tr><tr>
			<td width="40%"><b>', $txt['gmail'], ': </b><div class="smalltext">', $txt['gmail_in'], '</div></td>
			<td><input type="text" name="gmail" maxlength="50" size="24" value="', $context['member']['gmail']['name'], '" /></td>
							</tr><tr>
								<td colspan="2"><hr width="100%" size="1" class="hrcolor" /></td>
							</tr>';
