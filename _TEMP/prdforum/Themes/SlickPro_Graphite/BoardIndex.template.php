...
function template_main()
{
	...
	<div class="tborder" style="margin-top: ' , $first ? '0;' : '1ex;' , '' , $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'width: 100%;' : '', '">
		<div class="catbg', $category['new'] ? '2' : '', '" style="padding: 3px 5px 3px 10px;">';
		$first = false;
		...
		echo '
				', $category['link'], '
				<a href="', $scripturl, '?action=unread;c=', $category['id'], '"><img src="', $settings['images_url'], '/cat_unread.gif" alt="Unread Posts in Category" title="Unread Posts in Category" /></a>
		</div>';
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="5" class="bordercolor" style="margin-top: 1px;">
			<tr>
				...
				<td class="column-title">Threads</td>
				<td class="column-title">Posts</td>
			</tr>';
			...
			<tr>
				...
				if (!empty($board['last_post']['id']))
					echo '
						...
						In: <a href="', $scripturl . '?topic=' . $board['last_post']['topic'], '.0" />', ((substr($board['last_post']['subject'], 0,3) == 'Re:') ?  substr($board['last_post']['subject'],3)  : $board['last_post']['subject']), '</a>&nbsp;<a href="', $board['last_post']['href'], '"><img src="'. $settings['images_url']. '/subforum_off.gif" alt="Go to last post." title="Go to last post." /></a><br />
						By: ', $board['last_post']['member']['link'], '';
				echo '
					</span>
				</td>
				<td class="windowbg2" valign="middle" align="center" style="width: 45px;"><span class="smalltext">
					', $board['topics'],'
				</span></td>
				<td class="windowbg" valign="middle" align="center" style="width: 50px;"><span class="smalltext">
					', $board['posts'], '
				</span></td>
			</tr>';
				...
				if (!empty($board['children']))
				{
					...
					foreach ($board['children'] as $child)
					{
							...
							$children[] = $child['new'] ? '<a href="' . $scripturl . '?action=unread;board=' . $child['id'] . '.0"><img src="'. $settings['images_url']. '/subforum_on.gif" /></a> ' . $child['link'] : '<a href="' . $scripturl . '?action=unread;board=' . $child['id'] . '.0"><img src="'. $settings['images_url']. '/subforum_off.gif" /></a> ' . $child['link'];
					}
