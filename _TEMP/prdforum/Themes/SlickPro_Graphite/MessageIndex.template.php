...
function template_main()
{
	...
	<div class="tborder" style="margin-bottom: 3ex; ', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' width: 100%;' : '', '">
		<table border="0" width="100%" cellspacing="1" cellpadding="5" class="bordercolor">
			<tr>
				<td colspan="4" class="catbg"><span class="cat-whiteText">', $txt['parent_boards'], '</span></td>
			</tr>';
	...
	<form action="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" name="quickModForm" id="quickModForm" style="margin: 0;">';
		...
		// No topics.... just say, "sorry bub".
			...
			echo '
						<td class="catbg3" width="100%" colspan="7"><span class="cat-whiteText"><b>', $txt[151], '</b></span></td>';
...
$normalbar = true;
			...
			echo '
					<tr>
						<td class="windowbg2' , $topic['is_sticky'] ? 'pinned' : '' , '" valign="middle" align="center" width="5%">
							<img src="', $settings['images_url'], '/topic/', $topic['class'], '.gif" alt="" />
						</td>
						<td class="windowbg' , $topic['is_sticky'] ? 'pinned' : '' , '" valign="middle" align="center" width="4%">
							<img src="', $topic['first_post']['icon_url'], '" alt="" />
						</td>
						<td class="windowbg2' , !empty($settings['seperate_sticky_lock']) && $topic['is_sticky'] ? 'pinned' : '' , '" valign="middle" ', (!empty($topic['quick_mod']['remove']) ? 'id="topic_' . $topic['first_post']['id'] . '" onmouseout="mouse_on_div = 0;" onmouseover="mouse_on_div = 1;" ondblclick="modify_topic(\'' . $topic['id'] . '\', \'' . $topic['first_post']['id'] . '\', \'' . $context['session_id'] . '\');"' : ''), '>';
			...
			echo '
							', $topic['is_sticky'] ? '<b>' . substr($txt['quick_mod_sticky'], 0, 6) . ':</b> ' : '' , '<span id="msg_' . $topic['first_post']['id'] . '" title="', $topic['first_post']['preview'], '">', $topic['first_post']['link'], '</span>';
			...
			echo '
						...
						<td class="windowbg' , $topic['is_sticky'] ? 'pinned' : '' , '" valign="middle" width="14%">
							', $topic['first_post']['member']['link'], '
						</td>
						<td class="windowbg2' , $topic['is_sticky'] ? 'pinned' : '' , '" valign="middle" width="4%" align="center">
							', $topic['replies'], '
						</td>
						<td class="windowbg' , $topic['is_sticky'] ? 'pinned' : '' , '" valign="middle" width="4%" align="center">
							', $topic['views'], '
						</td>
						<td class="windowbg2' , $topic['is_sticky'] ? 'pinned' : '' , '" valign="middle" width="22%">
