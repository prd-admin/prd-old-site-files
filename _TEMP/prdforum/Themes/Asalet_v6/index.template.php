...
<tr>
<td  style="padding: 0ex 0px 0ex 0px;"><a href="'.$scripturl.'?action=forum" title=""><img src="', $settings['images_url'], '/logo.png"  alt="" /></a></td></tr></table>';
...
echo '
	...
	if($context['user']['is_logged'])
		echo '
				<td class="none" height="0" width="0">
		...
		<table cellspacing="0" cellpadding="3" border="0" align="center" width="100%">
			<tr>
				...
				<td valign="middle" align="center" style="white-space: nowrap;">
					...
					<a href="http://www.bilisimzamani.net" title="Asalet v6" target="_blank"> Asalet v6: deruni </a>
