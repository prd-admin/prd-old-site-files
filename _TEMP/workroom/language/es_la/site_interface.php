...
<?php
  ...
  */
  ...
  return array(
    ...
    'welcome to new account info' => '{0}, bienvenido a su nueva cuenta. De ahora en más, estará disponible en {1} (Puede almacenar este vínculo). Puede comenzar a utilizar su cuenta luego de completar los siguientes pasos:',
    'new account step1' => 'Paso 1: Cargue los datos de su empresa',
    'new account step1 info' => '<a class="internalLink" href="{0}">Fije los datos de su empresa</a> como ser teléfono, número de fax, dirección, correo, página we, etc.',
