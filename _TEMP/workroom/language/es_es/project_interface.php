...
// Options and descriptions
    ...
    'edit company data' => '<a class="internalLink" href="{0}">Editar</a> datos de la compañía',
    ...
    'link objects to object desc' => 'Use este formulario para vincular objetos a <strong><a href="%s">%s</a></strong>. Es posible vincular uno o más de un objeto. Puede elegir un objeto existente, o cargar otros. <strong>Los objetos nuevos, despues de ser cargados, estarán disponibles en la sección de archivos</strong>.',
