...
<table style="min-width:400px;margin-top:10px;" id="<?php echo $genid ?>-ws">
	<tr>
...
foreach($templates as $cotemplate) { 
	...
	<tr class="<?php echo $isAlt? 'altRow' : ''?>">
		<td><a class="internalLink ico-template bg-ico" href="<?php echo $cotemplate->getViewUrl() ?>"><?php echo clean($cotemplate->getName()) ?></a></td>
...
<?php } // if ?>
<br>
<a href="<?php echo get_url("template", "add") ?>" class="internalLink ico-add bg-ico"><?php echo lang("new template") ?></a>
</div>
</div>
