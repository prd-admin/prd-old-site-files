...
$mmessage = 'Okay faithful users...we\'re attempting to do some cool things. The forum will be back up this afternoon (1:00pm).';		# Description of why the forum is in maintenance mode.
...
$webmaster_email = 'admin@providencerollerderby.com';		# Email address to send emails from. (like noreply@yourdomain.com.)
...
$cachedir = '/home/content/p/r/o/providenceroll/html/prdforum/cache';
?>